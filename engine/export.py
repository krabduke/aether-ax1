"""Export the assembled engine. Run under `blender --background`.
    ...
    blender -b build/aether.blend -P engine/export.py -- glb
    blender -b build/aether.blend -P engine/export.py -- web     (decimated GLB)
    blender -b build/aether.blend -P engine/export.py -- stl     (one STL per part)
    blender -b build/aether.blend -P engine/export.py -- all
"""
...
def export_glb(name="aether.glb", draco=False):
...
def export_web(target_faces=680000):
    ...
    return export_glb("aether_web.glb", draco=True)
