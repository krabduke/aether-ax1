...
Colours and roughness are chosen to read as the actual materials: titanium in
the fan and front compressor, nickel alloy behind it, heat-tinted single-
crystal nickel in the turbine blades, and the matt grey-brown of
silicon-carbide ceramic-matrix composite wherever the gas is hottest -- the
combustor liners, the turbine nozzle, the augmentor and the nozzle flaps.
"""
...
def _add_wear(nt, bsdf, name):
    ...
    scale = {"nickel_hot": 95.0, "cmc": 80.0}.get(name, 130.0)
    strength = {"nickel_hot": 0.09, "cmc": 0.10}.get(name, 0.05)
