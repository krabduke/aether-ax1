...
CIRCUITS = [
    ...
    ("reheat fuel reaches every flameholder through the reheat control",
     ["fuel_lines", "ab_fuel_control", "ab_fuel_manifold", "flameholder_vanes"]),
    ("and the spraybars of zones 2 and 3", ["ab_fuel_manifold", "ab_spraybars"]),
    ("the pilot gutter sits on the vanes", ["flameholder_vanes", "ab_pilot_gutter"]),
