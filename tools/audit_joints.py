...
CIRCUITS = [
    ...
    ("and across each bearing to the motors that turn the ducts",
     ["swivel_rotary_union", "swivel_coupling_1", "swivel_hyd_fwd", "swivel_drive_2"]),
    ("", ["swivel_hyd_fwd", "swivel_coupling_2", "swivel_hyd_mid", "swivel_drive_3"]),
    ("and the nozzle's actuators",
     ["swivel_hyd_mid", "swivel_coupling_3", "swivel_hyd_aft", "nozzle_actuators"]),
    ("fuel: the pump through the oil cooler to the metering unit",
     ["fuel_pump", "fuel_lines", "fuel_oil_hx", "fuel_oil_hx_lines", "gearbox"]),
    ("the customer bleed off the case",
     ["case_outer_fwd", "bleed_valve"]),
    ("FADEC A drives the mode valve's actuators and the bleed valve",
     ["fadec_a", "front_harness", "mode_valve_actuators"]),
    ("", ["front_harness", "bleed_valve"]),
