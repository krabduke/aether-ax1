...
CIRCUITS = [
    ...
    ("the outer case is one vessel, inlet to nozzle",
     ["inlet_case", "flange_inlet", "case_fan", "flange_fan_aft",
      ...
      "flange_outer_aft", "nozzle_shroud"]),
    ...
    ("the flameholders hold the tail cone", ["augmentor_liner",
                                             "flameholder_vanes", "tailcone"]),
    ("reheat fuel reaches every flameholder",
     ["fuel_lines", "ab_fuel_manifold", "flameholder_vanes"]),
    ("the nozzle duct continues the augmentor",
     ["augmentor_liner", "nozzle_transition", "nozzle_sidewalls"]),
    ("the flaps are hinged and actuated",
     ["nozzle_transition", "nozzle_conv_flap_upper", "nozzle_div_flap_upper",
      "nozzle_ext_flap_upper", "nozzle_shroud"]),
    ("", ["nozzle_transition", "nozzle_conv_flap_lower", "nozzle_div_flap_lower",
          "nozzle_ext_flap_lower", "nozzle_shroud"]),
    ("", ["nozzle_sidewalls", "nozzle_hinges", "nozzle_div_flap_upper"]),
    ("", ["nozzle_sidewalls", "nozzle_actuators"]),
    ...
    ("the nozzle actuators are fed from the gearbox's pump",
     ["gearbox", "hydraulic_pump", "hydraulic_lines", "nozzle_actuators"]),
